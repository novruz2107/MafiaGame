...
public class ComissionerNight : LoopElement
{
    ...
    public override IEnumerator enumerator()
    {
        ...
        //choosing someone untill its not comissioner
        ...
        Debug.Log("Comissioner chose someone(id:" + GameLoopController.Current.players[chosen].Id + "). Comissioner Night is over.");
